...
2. After the questions, check: "Mais sobre [area], ou prosseguir?"
3. If more → ask 3-4 more, check again
4. After all areas → "Pronto para criar contexto?"

**Question design:**

- Options should be concrete ("Layout em cards" not "Opção A")
...
When user suggests scope creep: "Isso parece uma funcionalidade separada. Vou anotar em Ideias Adiadas. Voltando para [current area]."
