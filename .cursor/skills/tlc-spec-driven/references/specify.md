...
**Desafie a vaguidade.** Nunca aceite respostas vagas. "Bom" significa o quê? "Usuários" significa quem? "Simples" significa como? Torne o abstrato concreto: "Me mostre como usar isso." "Como isso realmente se parece?"

**Saiba quando parar.** Quando você entender o que eles estão construindo, por quê, para quem é, e como se parece quando está pronto — ofereça prosseguir.
