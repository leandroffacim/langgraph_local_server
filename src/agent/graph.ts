 ...
 */
const callModel = async (state: typeof StateAnnotation.State, _config: RunnableConfig): Promise<typeof StateAnnotation.Update> => {
  /**
...
//       {
//         role: "assistant",
//         content: `Hi there! How are you 221321312?`,
//       },
//     ],
//   };
// };
